...
export const WatchItemsTab: React.FC<ApiResponse | null> = ( response ) => {
  // let watchItems = [
  ...
  // let sortedWatchItems = [...watchItems].sort((a, b) => b.ranking - a.ranking);
  ...
  return (
    <div className="mt-4 bg-white border rounded p-4">
      ...
      {response.watchItems && (<div className="space-y-2 text-[11px]">
        {response.watchItems.map((item) => (
